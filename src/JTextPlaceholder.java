 ...
 *         <p>
 *         A custom textfield class that holds placeholder text when not focused and empty
 */
public class JTextPlaceholder extends JTextField {

    private boolean textWrittenIn = false;

    public JTextPlaceholder(String text) {
        setPlaceholder(text);
